...
| [**🩸 Glucose Control Optimization for Insulin Pump Therapy**](https://github.com/StevenMup2004/Glucose-Control-Optimization) <br>*(Jul 2024 - Sep 2024)* | • Modeled glucose-insulin dynamics using **ODEs**.<br>• Optimized insulin delivery using **Pontryagin's principle**.<br>• **First Prize** Mathematical Modeling Competition. |
