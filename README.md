<div align="center"> 
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=24&pause=1000&color=3366CC&center=true&vCenter=true&width=500&lines=Final-Year+IT+Student+at+HUST;Research+Assistant+at+BKAI+Center;Secure+Code+Generation+%26+NLP;Building+Safe+AI+Systems" alt="Typing SVG" />
  </a>
  ...
  <a href="mailto:dangvu.cspk53@gmail.com">
...
* **Hanoi University of Science and Technology (HUST)** | Information Technology (2022 - Present)
* **HNUE High School for Gifted Students** | Mathematics Specialized Class (2019 - 2022)

<div align="center"><hr style="border: none; border-top: 1px solid #e5e7eb; width: 70%;" /></div>

### 💼 Experience

#### **Intelligent Software Engineering Lab (BKAI Center)**
*Research Assistant | Oct 2022 - Present*
* Conducted research on code generation, completion, summarization, and repository topic recommendation.
* Analyzed security vulnerabilities in LLM-generated code and developed mitigation strategies.
...
| Project | Role & Impact |
|:---|:---|
| [**🛡️ LLM-Secure Code Generation**](https://github.com/StevenMup2004/Code-Gen) <br>*(May 2025 - Present)* | • Analyzed real-world vulnerabilities in LLM-generated code.<br>• Integrated **RAG** with trusted security guidelines.<br>• Improved security rate by **25.24%**. |
...
| [**📈 Forecasting Business Performance**](https://github.com/StevenMup2004/Forecasting-Business-Performance-DataFlow2025) <br>*(Feb 2025 - Mar 2025)* | • Built time-series models (**SARIMA, LSTM**) to forecast revenue.<br>• **Top 10 DataFlow Competition**. |
| **💬 Vietnamese Sentiment Analysis** <br>*(Sep 2024 - Dec 2024)* | • Built aspect-based sentiment analysis using **PhoBERT**.<br>• Applied back-translation data augmentation. |
| [**🩸 Glucose Control Optimization**](https://github.com/StevenMup2004/Glucose-Control-Optimization) <br>*(Jul 2024 - Sep 2024)* | • Modeled glucose-insulin dynamics using **ODEs**.<br>• Optimized insulin delivery using **Pontryagin's principle**.<br>• **First Prize** Mathematical Modeling Competition. |
